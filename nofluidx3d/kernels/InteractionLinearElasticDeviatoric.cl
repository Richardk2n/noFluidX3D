kernel void Interaction_LinearElasticDeviatoric(volatile global ibmPrecisionFloat* particleForce, const global ibmPrecisionFloat* points, const global uint* tetras, const global ibmPrecisionFloat* referenceEdgeVectors, const global ibmPrecisionFloat* referenceVolumes, const global ibmPrecisionFloat* shearModulus, const global ibmPrecisionFloat* bulkModulus, volatile global ibmPrecisionFloat* vonMises, volatile global ibmPrecisionFloat* pressure){
	...
	const ibmPrecisionFloat3 epsDev1 = eps1 - 1./3. * trEps * E1;
	const ibmPrecisionFloat3 epsDev2 = eps2 - 1./3. * trEps * E2;
	const ibmPrecisionFloat3 epsDev3 = eps3 - 1./3. * trEps * E3;
	// Cauchy Stress tensor 
	
	const ibmPrecisionFloat3 sigma1 = 2 * shearModulus[tetraID] * epsDev1 + bulkModulus[tetraID] * trEps * E1;
	const ibmPrecisionFloat3 sigma2 = 2 * shearModulus[tetraID] * epsDev2 + bulkModulus[tetraID] * trEps * E2;
	const ibmPrecisionFloat3 sigma3 = 2 * shearModulus[tetraID] * epsDev3 + bulkModulus[tetraID] * trEps * E3;
