ibmPrecisionFloat calcForceAdhesivePlane(const ibmPrecisionFloat3 pos, const ibmPrecisionFloat wallpos, const ibmPrecisionFloat adhesionConst, const ibmPrecisionFloat forceConst){
	const ibmPrecisionFloat d = pos.y - wallpos;
	return exp(-forceConst * d) - adhesionConst*exp(-d);
}
...
kernel void Interaction_HardAdhesivePlaneSurfaceIntegral(volatile global ibmPrecisionFloat* particleForce, const global ibmPrecisionFloat* points, const global uint* triangles, const ibmPrecisionFloat wallPos, const ibmPrecisionFloat adhesionConst, const ibmPrecisionFloat forceConst){
	...
	const ibmPrecisionFloat f1 = calcForceAdhesivePlane(x1, wallPos, adhesionConst, forceConst);
	const ibmPrecisionFloat f2 = calcForceAdhesivePlane(x2, wallPos, adhesionConst, forceConst);
	const ibmPrecisionFloat f3 = calcForceAdhesivePlane(x3, wallPos, adhesionConst, forceConst);
